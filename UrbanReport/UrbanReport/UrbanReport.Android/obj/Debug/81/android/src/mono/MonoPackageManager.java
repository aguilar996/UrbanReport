...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "UrbanReport.Android.dll" comes first in this list. */
		"UrbanReport.Android.dll",
		"FormsViewGroup.dll",
		...
		"Xamarin.Android.ImageCropper.dll",
		...
		"Xamarin.Forms.ImagePicker.Android.dll",
		"Xamarin.Forms.ImagePicker.dll",
